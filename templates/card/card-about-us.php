...
$jobseeker_description = get_field('jobseeker_description', $post_id);
?>
<div class="swiper-slide">
    <div class="jobseeker-card">
        <div class="image_jobseeker"><?= $post_image ?></div>

        <div class="play-btn" data-video="<?php echo $jobseeker_video_link ?>" data-name="<?php echo $jobseeker_name ?>" data-description="<?php echo $jobseeker_description ?>"><i class="icon-play2"></i></div>
