...
if (!class_exists('cyn-theme-init')) {
	class cyn_theme_init
	{
		...
		public function cyn_enqueue_files()
		{
			...
			wp_enqueue_style('cyn-compiled', get_stylesheet_directory_uri() . '/assets/css/compiled.css'); //When @build must change to final.css
			wp_enqueue_style('cyn-style', get_stylesheet_directory_uri());
			wp_dequeue_style('wp-block-library');



			wp_enqueue_script('cyn-global', get_stylesheet_directory_uri() . '/assets/js/dist/scripts.bundle.js', [], false, true); //When @build must change to scripts.bundle.min.js 
