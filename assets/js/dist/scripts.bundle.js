...
>>>>>>> ea56d01 (last changes)
  ...
  var bgColorMenuMobile = document.querySelector(".bg-color-menu-mobile");
  ...
  var setHeaderHeight = () => {
    ...
    const headerHeight2 = headerEl.clientHeight + "px";
    root.style.setProperty("--header-height", headerHeight2);
  };
...
<<<<<<< HEAD
  ...
  function Grid(_ref) {
    ...
    const updateSlide = (i, slide2, slidesLength, getDirectionLabel) => {
      ...
      slide2.style[getDirectionLabel("margin-top")] = row !== 0 ? spaceBetween && "".concat(spaceBetween, "px") : "";
    };
...
>>>>>>> ea56d01 (last changes)
  ...
  var setCssVariableGroup = () => {
    headerHeight = headerEl2.getClientRects()[0].height;
...
<<<<<<< HEAD
  var swiperService = new Swiper(".swiper-jobseeker-home", {
    slidesPerView: 1.25,
    breakpoints: {
      400: {
        slidesPerView: 1.5
  ...
  var popupHome = document.querySelector(".popup-home");
  var playBtnGroupHome = document.querySelectorAll(".play-btn");
  var btnClosePopupHome = document.querySelector(".btn-close-popup");
  var videoPopupHome = document.querySelector(".video-popup-jobseeker");
  var jobseekerNamePopupHome = document.querySelector(
    ".text-popup .jobseeker-name-popup"
  );
  var jobseekerDescriptionPopupHome = document.querySelector(
    ".text-popup .jobseeker-description-popup"
  );
=======
  gsapWithCSS.registerPlugin(ScrollTrigger2);
>>>>>>> ea56d01 (last changes)
  var ballSlide0 = document.querySelector(".slide-0 .ball");
  var mainSliderWrapper = document.querySelector(".slider-1-3-wrapper");
  var imgWrapper = document.querySelectorAll(".sidebar .img-wrapper");
  var slide1_Buttons = document.querySelectorAll(".slide-1 .btn-wrapper a");
  var mainBall = document.querySelector(".slider-1-3-wrapper .ball");
<<<<<<< HEAD
  var home = document.querySelector("main.home");
=======
>>>>>>> ea56d01 (last changes)
  var slide0_TL = gsapWithCSS.timeline({});
  var ballSlide0_TL = gsapWithCSS.timeline();
  var headerPurple_TL = gsapWithCSS.timeline();
...
>>>>>>> ea56d01 (last changes)
  ...
  slide0_TL.to(
    mainBall,
    {
      background: "radial-gradient(81.02% 126.66% at 26.6% 25.31%, #EC3232 0%, #D60000 28.53%, #8D0000 62.39%, #600 100%)"
    },
    "-=1"
  );
  slide0_TL.to(
  ...
  slide0_TL.to(
    mainBall,
    {
      background: "radial-gradient(145.63% 147.53% at 19.66% 4.52%, #8A88FF 0%, #514EDB 18.02%, #312FAA 33.86%, #1A1885 63.34%, #010037 100%)"
    },
    "-=1"
  );
  slide0_TL.to(mainBall, {
...
<<<<<<< HEAD
  ...
  var titleImageSlider = document.querySelectorAll(".title-image-slider");
  ...
  var setMarginRight = () => {
    titleImageSlider.forEach((el) => {
      el.style.marginRight = header2.offsetLeft + "px";
    });
    btnNextAboutUs.style.right = header2.offsetLeft + 50 + "px";
    btnPrevAboutUs.style.right = header2.offsetLeft + 110 + "px";
  };
  var swiperBtnPrevAboutUs = document.querySelector(".btn-prev-about-us");
  var swiperBtnNextAboutUs = document.querySelector(".btn-next-about-us");
  var informationSlider = document.querySelector(".title-image-slider");
  var setSpacerHeight = () => {
    const height = backgroundSlider.clientHeight + "px";
    calcSpacer.style.marginTop = height;
  };
  var setNavigationPlace = () => {
  ...
  var getMarginRightTitle = document.querySelector("#getMarginRightTitle");
  ...
  var swiperService2 = new Swiper("#swiperService", {
    slidesPerView: 1.85,
    spaceBetween: 1,
    navigation: {
